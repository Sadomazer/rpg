import { animatedEx, clamp } from './util';
...
class MovableObject extends PositionedObject {
  ...
  animateMotion(time) {
    if (this.speed) {
      ...
      const dx = animatedEx(me.deltaX, me.motionStartTime, time, me.speed);
      const dy = animatedEx(me.deltaY, me.motionStartTime, time, me.speed);
